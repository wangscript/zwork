...
(function($,$ui){
	...
	window.window = function(_config){
		...
		var initjqobj = function(){
			...
			jqobj.top_border_center = jqobj.top_border.children(".window_center");
			jqobj.top_border_right = jqobj.top_border.children(".window_right");
			jqobj.top_titlebar = jqobj.top.children(".window_titlebar");
			jqobj.top_titlebar_ico = jqobj.top_titlebar.children(".window_ico");
			jqobj.top_titlebar_title = jqobj.top_titlebar.children(".window_title");
			jqobj.top_titlebar_buttons = jqobj.top_titlebar.children(".window_buttons");
			jqobj.top_titlebar_buttons_close = jqobj.top_titlebar_buttons.children(".window_close");
			jqobj.top_titlebar_buttons_close.mouseoverout("window_close_hover");
			jqobj.top_titlebar_buttons_maxre = jqobj.top_titlebar_buttons.children(".window_maxre");
			jqobj.top_titlebar_buttons_maxre.mouseoverout("window_maxre_hover");
			jqobj.top_titlebar_buttons_min = jqobj.top_titlebar_buttons.children(".window_min");
			jqobj.top_titlebar_buttons_min.mouseoverout("window_min_hover");
			jqobj.center = jqobj.obj.children(".window_center");
			jqobj.center_leftborder = jqobj.center.children(".window_leftborder");
			jqobj.center_loading = jqobj.center.children(".window_loading");
			jqobj.center_content = jqobj.center.children(".window_content");
			jqobj.center_scroll = jqobj.center.children(".window_scroll");
			jqobj.center_rightborder = jqobj.center.children(".window_rightborder");
			jqobj.bottom = jqobj.obj.children(".window_bottom");
			jqobj.bottom_border = jqobj.bottom.children(".window_border");
			jqobj.bottom_border_left = jqobj.bottom_border.children(".window_left");
			jqobj.bottom_border_center = jqobj.bottom_border.children(".window_center");
			jqobj.bottom_border_right = jqobj.bottom_border.children(".window_right");
			jqobj.bottom_statebar = jqobj.bottom.children(".window_statebar");
		};
